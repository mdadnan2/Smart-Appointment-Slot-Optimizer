...
import { Mail, Bell, Search, Calendar as CalendarIcon, Clock, CheckCircle } from 'lucide-react';
          ...
          {upcomingAppointments.length === 0 ? (
            ...
            <div className="space-y-2">
              {upcomingAppointments.slice(0, 4).map((apt) => (
                <div
                  key={apt.id}
                  className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 p-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100 w-full max-w-full"
                >
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm w-full max-w-full">
          ...
          <div className="space-y-2">
            {appointments.slice(0, 5).map((apt) => (
              <div key={apt.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 p-2 bg-gray-50 rounded-lg w-full max-w-full">
                <div className="flex items-center gap-2 min-w-0 flex-1">
