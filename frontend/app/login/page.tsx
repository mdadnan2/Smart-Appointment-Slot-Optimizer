...
export default function Login() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-indigo-600 p-4 overflow-y-auto">
      <div className="bg-white px-5 py-4 rounded-2xl shadow-2xl w-full max-w-xs my-auto animate-scale-in">
        ...
        <div className="text-center mt-4">
          <p className="text-gray-600 mb-1 text-xs">Don't have an account?</p>
          <a href="/register" className="text-blue-600 font-semibold hover:text-blue-700 hover:underline transition-all text-xs">
            Register Here
          </a>
        </div>
